...
grep -q 'tuinstra-tracker-deploy' "$role/templates/tuinstra-compose-deploy.j2"
grep -q 'tracker release identity is invalid' "$role/templates/tuinstra-compose-deploy.j2"
grep -q 'deploy tracker' "$role/templates/tuinstra-deploy-shell.j2"
